...
def createVtk(dic, name, folder, step, fields) :
    ...
    toc_create = time.perf_counter()
    print(f"Points Data complete: {toc_create - tic_create:0.4f} s")
    tic_create = time.perf_counter()
    ...
    toc_create = time.perf_counter()
    print(f"Field Data complete: {toc_create - tic_create:0.4f} s")
