...
Return average along with the standard error
@author: MM42910
"""
...
caseShort = "B1"
options = "lsd" #Length, division rate, strain
...
if not os.path.exists("Png"):
   os.mkdir("Png")
if not os.path.exists("Png\\"+caseName+"-"+str(n_avg)):
    os.mkdir("Png\\"+caseName+"-"+str(n_avg))
...
#    nb = [0] * len(bins)
    ...
    if opt_len == True:
        ...
        plt.savefig("Png\\"+caseName+"-"+str(n_avg)+"\\Len"+str(n_avg)+"-"+currentCaseName[4:-4]+".png")
        # Clear figure
        plt.clf()  
