...
def createVtk(dic, name, folder, step, fields) :
    ...
    fic = open(folder + "/" + name + "Aug_{:04d}.vtk".format(step), "w")
    ...
    print(f"Data 1 complete: {toc - tic:0.4f} s")
...
name = "A2-AceShort"
folder = "..//Output"
fields = "Pos.x;Pos.y;Pos.z;Idp;Vel.x;Vel.y;Vel.z;Rhop;Mass;Press;Type;Acec.x;Acec.y;Acec.z;CellOffSpring;GradVel;Qfxx;Qfxy;Qfxz;Qfyy;Qfyz;Qfzz;VonMises3D;StrainDot.x;StrainDot.y;StrainDot.z".split(";")
#fields = arguments[3:]
i = 0
...
while os.path.exists(folder + "/" + name + "_{:04d}.csv".format(i)) :
    ...
    print(name + "Aug_{:04d}.vtk created".format(i))
    i += 1